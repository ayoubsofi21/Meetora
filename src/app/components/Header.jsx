        ...
        <div className="flex items-center justify-between h-16">
          <a href="/" className="flex items-center gap-1 cursor-pointer">
            <img
              src={logo}
              alt="logo"
              className="h-12 w-12 object-contain transition-transform duration-300 scale-105"
            />

            <span className="text-2xl font-bold text-slate-900 tracking-tight hover:text-indigo-600 transition-colors">
              Meetora
            </span>
          </a>
          {/* Desktop Navigation */}
