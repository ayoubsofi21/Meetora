...
import {  Activity,  Pill,  Save,  Loader2,  AlertCircle,  CheckCircle2,  ArrowLeft} from "lucide-react";
...
const handleSaveConsultation = async (e) => {
    ...
    try {
      ...
      setError(
        ...
        Object.values(err.response?.data?.errors || {}).flat().join(' ') || 'Failed to save consultation.');
    } finally {
              ...
              <div className="space-y-5">
                <div>
                  <label className="block text-sm font-semibold text-[#475569] mb-2">
                    Primary Diagnosis <p className="inline text-red-500">*</p>
                  </label>
                  <input
                    type="text"
                    value={diagnosis}
